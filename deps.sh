...
(cd or-tools_ubuntu-18.04_v7.4.7247.tar.gz/lib ; mvn install:install-file -Dfile=com.google.ortools.jar -DgroupId=com.google -DartifactId=ortools -Dversion=7.4 -Dpackaging=jar)
